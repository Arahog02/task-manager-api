package br.net.api.lmg.crud.rest;
...
import br.net.api.lmg.crud.model.Login;
import br.net.api.lmg.crud.model.Usuario;
import br.net.api.lmg.crud.repository.UsuarioRepository;
 ...
 * @DeleteMapping("/usuarios/{id}")
    ...
    public ResponseEntity<Usuario> login(@RequestBody Login login){
        ...
        .filter(usu -> usu.getEmail().equals(login.getLogin()) && usu.getSenha().equals(login.getSenha()))
        .findAny().orElse(null);
 ...
 *  static{
    lista.add( new Usuario(1,"Lucas","lucas.gohara","12345"));
    lista.add( new Usuario(2,"Fernando","fernando.gorski","abcd"));
    lista.add( new Usuario(3,"Hygor","hygor.adriano","hygor"));
   }
